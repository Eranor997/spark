...
ch_db_name = "default"
ch_dst_table = "shkDefect_verdict_local"
...
spark_app_name = "shkDefect_verdict_local"
spark_ui_port = "8081"
...
columns_to_ch = ("shk_id", "place_code", "reason_id", "employee_id")
...
schema = StructType([
    ...
    StructField("operation_dt", StringType(), True),
    StructField("place_code", LongType(), True),
...
sql_insert = f"""insert into {ch_db_name}.{ch_dst_table}
    ...
    (
        select 
            place_cod,
            office_id
        from default.dict_StoragePlace
    ) t2
    on t1.place_code = t2.place_cod
"""
